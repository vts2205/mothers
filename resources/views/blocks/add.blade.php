            ...
            <div class="col-md-12">
                <div class="m-portlet">
                    <div class="m-portlet__body">
                        <!--begin::Section-->
                        <div class="m-section">
                            <form method="post" action="{{ route('discounts.store') }}"  id="upload" class="validation_form" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                            <div class="col-md-8">
                                <div class="m-section__content">
                                   ...
                                   <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-7">
                                            <input value="{{ old('discount') }}" type="text" autocomplete="off" class="form-control" name="discount" />
                                            @error('discount')
                                              <span class="invalid-feedback" role="alert">
                                                 {{ $message }}
                                              </span>
                                        ...
                                        <div class="col-md-7">
                                            ...
                                            <input type="text" class="form-control" value="{{ !empty(old('validity')) ? date('d-m-Y', strtotime(old('validity'))) : "" }}"   name="validity" autocomplete="off">
